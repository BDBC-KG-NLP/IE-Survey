...
⼯业级的NLP⼯具：功能很强⼤，不⽌是做Information Extraction，⽤Cython优化，各种处理超级快（官网fastest in the world），能⽤于在真实场景和产品里的。适合对用于Deep Learning的⽂本进行预处理。能和TensorFlow, PyTorch, scikit-learn, Gensim 等深度学习框架无缝衔接。
